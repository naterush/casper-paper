...
Equivocation, Byzantine fault detection, protocol states, and prtocol state transitions are defined here in \emph{precisely} the same way as in the binary consensus. We therefore don't give the definitions again. 
